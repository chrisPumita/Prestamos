<?php
#construimos y verificmos si se esta realizando una peticion AJAX 
if ($peticionAjax) {
    # inlcuimos desde el archivo plantilla
    include_once "../config/SERVER.php";
}
else {
    # inlcuimos desde el archivo index.php
    include_once "./config/SERVER.php";
}
...
class mainModel
{
    ...
    {
        #ruta para la conexion a MySQL
        $conexion = new PDO(SGDB,USER,PASS);
        $conexion -> exec("SET CHARACTER SET utf8");
        return $conexion;
    }

    /*--------------- Funcion para ejecutar consultas simples a mysql -----------------------*/
    protected static function ejecutar_consulta_simple($consulta)
    {
        #Preparamos la peticion para poder ejecutar la consulta con sql trauendo la funcion consultar
